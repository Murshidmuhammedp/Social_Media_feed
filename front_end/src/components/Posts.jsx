...
export default function InstagramPost() {
  const userId = '67b4673057c00b3fad1e696f'

  const handleSubmitPost = async () => {
    const response = await axios.post(`http://localhost:1000/api/posts/comment/${'67b4673057c00b3fad1e696f'}`, { text, userId })
  ...
  return (
    ...
    >
      ...
      <CardContent orientation="horizontal" sx={{ gap: 1 }}>
        ...
        />
        <Link underline="none" role="button" onClick={handleSubmitPost}>
          Post
        </Link>
      </CardContent>
    </Card>
